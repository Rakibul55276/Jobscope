		...
		<div id="page-bgtop">
			...
			<div id="content">
				<div class="post">
					...
					<h2 class="title">UPDATE Profile</a></h2>
					<p class="meta">Please fill up the form</p>
					<div class="entry">
						<form action="update_employee.php" method="post" enctype="multipart/form-data">
						     Employee ID <br> <input type="TEXT" name="id" style="width:100px;">
							<br><br>FULL NAME <br> <input type="text" name="nm" style="width:200px;">
